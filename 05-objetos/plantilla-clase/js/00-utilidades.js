 ...
 *
 * ----------------------------------------------------------------------------
 * PLANTILLA DE CLASE: este archivo viene COMPLETO y FUNCIONANDO.
 * Es ANDAMIAJE, no materia: sin imprimir() y titulo() no se podría demostrar
 * nada en pantalla desde el primer minuto de clase. Se explica de palabra
 * (2-3 minutos) y se pasa directamente al archivo 01.
 * ============================================================================
 */
